...
import fr.eql.ai113.petpal.spring.back.entity.dto.Pages;
import fr.eql.ai113.petpal.spring.back.entity.dto.Query;
...
class GlossaryServiceImplTest {
    ...
    private static final String REST_ISSUE_EXPECTED_RETURN =
            "Une erreur s'est produite lors de l'appel Rest vers l'API Wikipedia.";
    ...
    /** Instancié dans le setUp() avant chaque test. */
