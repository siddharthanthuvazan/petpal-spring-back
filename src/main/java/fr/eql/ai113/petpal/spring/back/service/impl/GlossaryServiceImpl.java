...
import fr.eql.ai113.petpal.spring.back.entity.dto.WikiExtract;
import fr.eql.ai113.petpal.spring.back.repository.GlossaryDao;
...
public class GlossaryServiceImpl implements GlossaryService {
    ...
    /**
     * Constructeur à appeler pour tester les méthodes de cette classe
     * @param restTemplate Un mock du RestTemplate
     */
    ...
    public String fetchExtract(String expression) {
        ...
        if (wikiExtract == null) {
            return "Une erreur s'est produite lors de l'appel Rest vers l'API Wikipedia.";
        }
